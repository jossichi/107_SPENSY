  ...
  <div class="container_footer">
    <div class="site-footer-inner has-top-divider">
      <div class="footer-copyright">
        &copy; 2024 bản quyền thuộc về nhóm đồ án 107 SPENSY
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    // Include external script initialization if necessary
