        ...
        <section class="hero">
          <div class="container">
            <div class="hero-inner">
              <div class="hero-copy">
                <h1 class="hero-title mt-0 is-revealing">107 SPENSY AI</h1>
                <p class="hero-paragraph is-revealing">
                  Mô tả: nhóm nghiên cứu tập trung nghiên cứu fundamental model
                  AI để phân loại văn bản ngắn và gợi ý mentor cho mentee
                </p>
              </div>
                ...
                <div class="feature">
                  <div class="feature-inner">
                    <div class="feature-header mb-16">
                      ...
                      <h4 class="feature-title m-0">BERT</h4>
                    </div>
                    <p class="text-sm mb-0">
                      Nhóm nghiên cứu tập trung sử dụng mô hình BERT để phân
                      loại văn bản, nhưng sử dụng thêm BART để tóm tắt văn bản
                      mục đích là giảm thiểu số lượng từ trong câu văn để BERT
                      phân loại tốt hơn
                    </p>
                  </div>
                </div>
                  ...
                  <div class="feature-inner">
                    <div class="feature-header mb-16">
                      ...
                      <h4 class="feature-title m-0">
                        DSA trong gợi ý mentor cho mentee
                      </h4>
                    </div>
                    <p class="text-sm mb-0">
                      Nhóm đồ án sử dụng mô hình cây K-ary để xây dựng mô tả mối
                      quan hệ các chuyên môn từ đó giúp tìm kiếm mentor phù hợp
                      mentee tốt hơn và đơn giản quá trình tìm kiếm
                    </p>
                  </div>
                </div>
              </div>
