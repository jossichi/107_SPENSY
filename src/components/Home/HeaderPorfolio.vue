      ...
      <section id="home" class="home">
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
              <div
                class="main_home text-center colorstext wow fadeInUp"
              ...
              >
                ...
                <a href="#!" class="btn btn-default waves-effect waves-purple"
                  >learn more</a
                >
              </div>
            </div>
                  ...
                  <div class="row">
                    <div class="col-sm-4 col-sm-offset-1">
                      <div class="single_abt single_about">
                        ...
                        <p class="text-uppercase colorstext">
                        ...
                        <a
                          href="#!"
                          class="btn btn-primary waves-effect waves-teal margin-top-40"
                          >About Us</a
                        >
                      </div>
                    </div>
              ...
              <div class="col-sm-4 no-padding">
                <div class="bottom_single_about s_bootom_right_area">
                  ...
                  <div class="s_bottom_ab_text text-center">
                    <h4>Tobias Van Schneider Interview</h4>
                    <a
                      href="assets/images/video/ocean.mp4"
                      class="gallery-video"
                      ><img src="assets/images/vicon.png" alt=""
                    /></a>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="main_tobias_area sections">
              ...
              <div class="col-sm-5 col-sm-offset-1">
                <div
                  class="single_abt single_tobias single_tobias_text wow fadeInRight"
                >
                  ...
                  <a href="" class="btn btn-primary margin-top-40"
                    >about tobias</a
                  >
                </div>
              </div>
          ...
          <div class="row">
            <div class="main_service_area main_team_area">
              <div class="head_title text-center wow fadeInUp">
                <h2>Our Team</h2>
                <p>
                  Loem Ipsum has been the industry's standard dummy text ever
                  since the 1500s, when an unknown printer took a galley of type
                  and scrambled it to make
                </p>
              </div>
          ...
          <div class="row">
            <div class="main_service_area main_contactus_area">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div
                    class="single_contant_left margin-top-60 margin-bottom-80 wow rollIn"
                  >
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 margin-bottom-30">
                          <input
                            type="submit"
                            value="Send message"
                            class="btn btn-primary btn-colors"
                          />
                        </div>
                      </div>
                    </form>
                ...
                <div class="col-sm-6">
                  <div
                    class="contact_us_right margin-top-60 margin-bottom-80 wow fadeInLeft"
                  >
            ...
            <div class="main_footer">
              ...
              <div class="col-sm-8">
                <div class="copyright_text margin-top-20">
                  <p class="wow fadeInRight animated" data-wow-duration="1s">
